...
@section('css')
@parent
<link rel="stylesheet" href="{{ asset('css/popup-home.css?v='.$asset_v) }}"/>
@endsection
@section('content')
...
<div class="popup">
	<div class="contentBox">
		<div class="close"></div>
			<div class="content">
			 <?php echo $popup_post->popup_post; ?> 
		</div>
		</div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
          @if (!empty($popup_post))
          colsePopup({{$popup_post->popup_time}}*1000);
        @endif      
        });
    ...
    <script src="{{ asset('js/popup-home.js') }}"></script>
@endsection
