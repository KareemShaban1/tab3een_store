...
<div class="intro-section pt-3 pb-3 mb-2">
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                ...
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/slider/slide-1.jpg')}}" alt="Image Desc">
                                            </picture>
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                ...
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/slider/slide-2.jpg')}}" alt="Image Desc">
                                            </picture>
                                        </figure><!-- End .slide-image -->
                        ...
                        <div class="col-lg-4">
                            <div class="intro-banners">
                                <div class="banner mb-lg-1 mb-xl-2">
                                    <a href="#">
                                        <img src="{{url('frontend2/assets/images/demos/demo-3/banners/banner-1.jpg')}}" alt="Banner">
                                    </a>
                                ...
                                <div class="banner mb-lg-1 mb-xl-2">
                                    <a href="#">
                                        <img src="{{url('frontend2/assets/images/demos/demo-3/banners/banner-2.jpg')}}" alt="Banner">
                                    </a>
                                ...
                                <div class="banner mb-0">
                                    <a href="#">
                                        <img src="{{url('frontend2/assets/images/demos/demo-3/banners/banner-3.jpg')}}" alt="Banner">
                                    </a>
            ...
            @include('frontend.pages.home.tabs',$products)
                                    ...
                                    <div class="col-6">
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-5.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6">
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                <span class="product-label label-circle label-sale">Sale</span>
                                                <a href="product.html">
                                                    <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-6.jpg')}}" alt="Product image" class="product-image">
                                                </a>
            ...
            <div class="container">
                <div class="owl-carousel mt-5 mb-5 owl-simple" data-toggle="owl" 
                        ...
                        <a href="#" class="brand">
                            <img src="{{url('frontend2/assets/images/brands/1.jpg')}}" alt="Brand Name">
                        </a>

                        <a href="#" class="brand">
                            <img src="{{url('frontend2/assets/images/brands/2.jpg')}}" alt="Brand Name">
                        </a>

                        <a href="#" class="brand">
                            <img src="{{url('frontend2/assets/images/brands/3.jpg')}}" alt="Brand Name">
                        </a>

                        <a href="#" class="brand">
                            <img src="{{url('frontend2/assets/images/brands/4.jpg')}}" alt="Brand Name">
                        </a>

                        <a href="#" class="brand">
                            <img src="{{url('frontend2/assets/images/brands/5.jpg')}}" alt="Brand Name">
                        </a>

                        <a href="#" class="brand">
                            <img src="{{url('frontend2/assets/images/brands/6.jpg')}}" alt="Brand Name">
                        </a>
            ...
            <div class="container trending">
                ...
                <div class="row">
                    <div class="col-xl-5col d-none d-xl-block">
                        <div class="banner">
                            <a href="#">
                                <img src="{{url('frontend2/assets/images/demos/demo-3/banners/banner-4.jpg')}}" alt="banner">
                            </a>
                        </div><!-- End .banner -->
                    </div><!-- End .col-xl-5col -->
                                ...
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-top">Top</span>
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-7.jpg')}}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-8.jpg')}}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            ...
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-9.jpg')}}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            ...
                                            <span class="product-label label-circle label-sale">Sale</span>
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-10.jpg')}}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-top">Top</span>
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-15.jpg')}}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-top">Top</span>
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-11.jpg')}}" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-new">New</span>
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-13.jpg')}}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-12.jpg')}}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            ...
                                            <span class="product-label label-circle label-sale">Sale</span>
                                            <a href="product.html">
                                                <img src="{{url('frontend2/assets/images/demos/demo-3/products/product-14.jpg')}}" alt="Product image" class="product-image">
                                            </a>
