    ...
    @component('components.widget', ['class' => 'box-solid'])
            @slot('tool')
                <div class="box-tools">
                    ...
                    data-href="{{action('ApplicationDashboard\ApplicationCategoryController@create')}}?type={{request()->get('type')}}" 
...
@stop
@section('javascript')
@includeIf('applicationDashboard.pages.categories.categories_js')
@endsection
