    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[disable_time_deliver]', 1,  $pos_settings['disable_time_deliver'] , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.disable_time_deliver' ) }}
                  </label>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[disable_side_categories]', 1,  $pos_settings['disable_side_categories'] , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.disable_side_categories' ) }}
                  </label>
                </div>
            </div>
        </div>
