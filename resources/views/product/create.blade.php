...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    ...
    <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('application_category_id', __('product.application_category') . ':') !!}
              {!! Form::select('application_category_id', $applicationCategories, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('active_in_app', 1,  false, ['class' => 'input-icheck']); !!} 
              <strong>@lang('lang_v1.active_in_application')</strong>
            </label> 
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('featured', 1,  false, ['class' => 'input-icheck']); !!} 
              <strong>@lang('lang_v1.featured')</strong>
            </label> 
            <!-- @show_tooltip(__('lang_v1.tooltip_sr_no')) -->
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('show_in_home', 1,  false, ['class' => 'input-icheck']); !!} 
              <strong>@lang('lang_v1.show_in_home')</strong>
            </label> 
            <!-- @show_tooltip(__('lang_v1.tooltip_sr_no')) -->
          </div>
        </div>
