	...
	<div class="col-md-4">
		<div class="form-group">
			<div class="input-group">
				...
				<span class="input-group-btn">
					<button type="button" class="btn edit_this_customer btn-default bg-white btn-flat" data-name=""  @if(!auth()->user()->can('customer.create')) disabled @endif><i class="fas fa-edit text-primary fa-lg"></i></button>
				</span>
			</div>
			<div class="form-group">
                <small class="hide contact_name"><strong style="color: black">@lang('contact.name'):&nbsp; </strong><span></span></small>
                <small class="hide contact_phone"><strong style="color: black">@lang('contact.mobile'):&nbsp; </strong><span></span></small><br>
                <small class="hide contact_address1"><strong style="color: black">@lang('contact.address1'):&nbsp; </strong><span></span></small>&nbsp;
                <small class="hide contact_address2"><strong style="color: black">@lang('contact.address2'):&nbsp;</strong><span></span></small>

            </div>
		</div>
	</div>
	@if($pos_settings['disable_time_deliver'] != 1)
		<div class="col-md-3 col-sm-6" style="float:left;">
			<div class="form-group">
				
				{!! Form::time('time_deliver','00.00', ['class' => 'input-form', 'style' => "border: 1px solid #c9b2b242;width: 75%; height: 33px; content:'وقت الوصول:';margin-left:.6em;color:#9d9d9d;",'placeholder'=>'وقت الوصول']); !!}
			</div>
		</div>
	@endif
