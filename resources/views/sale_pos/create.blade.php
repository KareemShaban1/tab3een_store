	...
	<div class="row mb-12">
		<div class="col-md-12">
			<div class="row">
				...
				<div class="{{!empty($pos_settings['disable_side_categories']) ?'col-md-5':'col-md-4' }} no-padding">
					@include('sale_pos.partials.pos_sidebar')
				</div>
			
				@endif
				@if (empty($pos_settings['disable_side_categories']))
					<div class="col-md-1">
				
						@include('sale_pos.partials.side_categories2')
...
<div class="modal fade contact_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
	@include('contact.create2', ['quick_add' => true])
</div>
<div id="edit_contact_container" class='contact_modal'>
