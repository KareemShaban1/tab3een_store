...
<<<<<<< HEAD
    Route::resource('applicationDashboard/categories', 'ApplicationDashboard\ApplicationCategoryController');
    Route::get('categories-ajax-index-page', 'ApplicationDashboard\ApplicationCategoryController@getCategoryIndexPage');
=======
