...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $applicationCategories = ApplicationCategory::forDropdown($business_id, 'product');
        //product screen view from module
        $pos_module_data = $this->moduleUtil->getModuleData('get_product_screen_top_view');

        return view('product.create')
            ->with(compact('categories','applicationCategories', 'brands', 'units', 'taxes', 'barcode_types', 'default_profit_percent', 'tax_attributes', 'barcode_default', 'business_locations', 'duplicate_product', 'sub_categories', 'rack_details', 'selling_price_group_count', 'module_form_parts', 'product_types', 'common_settings', 'warranties', 'pos_module_data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
<<<<<<< HEAD
            $form_fields = ['name','active_in_app','show_in_home','featured' ,'brand_id', 'unit_id', 'category_id', 'tax', 'type', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_custom_field1', 'product_custom_field2', 'product_custom_field3', 'product_custom_field4', 'product_description', 'sub_unit_ids'];
=======
...
>>>>>>> f47e249ab307df6aa698d28fb3d62b4b1aab0a1a
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
<<<<<<< HEAD
            $product_details = $request->only(['name','active_in_app','show_in_home','featured', 'brand_id', 'unit_id', 'category_id', 'tax', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_custom_field1', 'product_custom_field2', 'product_custom_field3', 'product_custom_field4', 'product_description', 'sub_unit_ids']);
=======
...
>>>>>>> f47e249ab307df6aa698d28fb3d62b4b1aab0a1a
            ...
            $product->active_in_app = $product_details['active_in_app'];
            $product->show_in_home = $product_details['show_in_home'];
            $product->featured = $product_details['featured'];
