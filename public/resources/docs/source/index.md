...
[Get Postman Collection](https://www.onoo.online/brand/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://www.onoo.online/brand/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"exercitationem","ip_address":"illo","latitude":"nostrum","longitude":"laborum"}'
...
```bash
curl -X POST \
    "http://www.onoo.online/brand/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"eum","latitude":"enim","longitude":"aspernatur"}'
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/holidays?location_id=dignissimos&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=dolores&follow_up_type=reprehenderit&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "http://www.onoo.online/brand/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=ad&biz_name=ratione&mobile_num=8&contact_id=totam&order_by=repellendus&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://www.onoo.online/brand/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"saepe","mobile_name":"error","call_type":"call","start_time":"voluptatem","end_time":"eaque","duration":"ab"}]}'
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=voluptates&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":16,"initial_amount":56.3509999999999990905052982270717620849609375,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":66099723.634221591055393218994140625,"total_card_slips":5,"total_cheques":15,"closing_note":"qui","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 16,
    "initial_amount": 56.3509999999999990905052982270717620849609375,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 66099723.634221591055393218994140625,
    "total_card_slips": 5,
    "total_cheques": 15,
    "closing_note": "qui",
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/contactapi?type=ut&name=quam&biz_name=laborum&mobile_num=14&contact_id=quis&order_by=delectus&direction=voluptatem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"libero","prefix":"qui","first_name":"labore","middle_name":"rerum","last_name":"dolores","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"vitae","address_line_2":"quisquam","city":"est","state":"blanditiis","country":"nemo","zip_code":"eos","customer_group_id":"corporis","contact_id":"earum","dob":"2000-06-13","custom_field1":"ut","custom_field2":"nostrum","custom_field3":"assumenda","custom_field4":"nobis","email":"porro","shipping_address":"laudantium","position":"commodi","opening_balance":0,"source_id":10,"life_stage_id":17,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_2": "quisquam",
    "city": "est",
    "state": "blanditiis",
    "country": "nemo",
    "zip_code": "eos",
    "customer_group_id": "corporis",
    "contact_id": "earum",
    "dob": "2000-06-13",
    "custom_field1": "ut",
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"dolor","prefix":"cumque","first_name":"consequatur","middle_name":"beatae","last_name":"est","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"qui","address_line_2":"et","city":"ut","state":"sapiente","country":"et","zip_code":"voluptatibus","customer_group_id":"natus","contact_id":"tempora","dob":"2000-06-13","custom_field1":"minus","custom_field2":"nihil","custom_field3":"in","custom_field4":"quis","email":"molestiae","shipping_address":"eos","position":"quod","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":13,"life_stage_id":1,"assigned_to":[]}'
...
let body = {
    ...
    "state": "sapiente",
    "country": "et",
    "zip_code": "voluptatibus",
    "customer_group_id": "natus",
    "contact_id": "tempora",
    "dob": "2000-06-13",
    "custom_field1": "minus",
    "custom_field2": "nihil",
...
```bash
curl -X POST \
    "http://www.onoo.online/brand/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":8,"card_number":"soluta","card_holder_name":"incidunt","card_transaction_number":"fugiat","card_type":"quis","card_month":"asperiores","card_year":"rerum","card_security":"aut","transaction_no_1":"dolorem","transaction_no_2":"ipsa","transaction_no_3":"debitis","cheque_number":"necessitatibus","bank_account_number":"culpa","note":"possimus"}'
...
let body = {
    ...
    "account_id": 8,
    "card_number": "soluta",
    "card_holder_name": "incidunt",
    "card_transaction_number": "fugiat",
    "card_type": "quis",
    "card_month": "asperiores",
    "card_year": "rerum",
    "card_security": "aut",
    "transaction_no_1": "dolorem",
    "transaction_no_2": "ipsa",
    "transaction_no_3": "debitis",
    "cheque_number": "necessitatibus",
    "bank_account_number": "culpa",
    "note": "possimus"
}
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/expense?location_id=odit&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=quo&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":17,"final_total":248,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":3,"expense_for":6,"contact_id":19,"additional_notes":"sequi","is_refund":0,"is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"dolore","recur_repetitions":8,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":11,"card_number":"aut","card_holder_name":"omnis","card_transaction_number":"libero","card_type":"placeat","card_month":"quas","card_year":"adipisci","card_security":"voluptatem","transaction_no_1":"quisquam","transaction_no_2":"amet","transaction_no_3":"atque","note":"sunt","cheque_number":"occaecati"}]}'
    ...
    "payment": [
        {
            ...
            "account_id": 11,
            "card_number": "aut",
            "card_holder_name": "omnis",
            "card_transaction_number": "libero",
            "card_type": "placeat",
            "card_month": "quas",
            "card_year": "adipisci",
            "card_security": "voluptatem",
            "transaction_no_1": "quisquam",
            "transaction_no_2": "amet",
            "transaction_no_3": "atque",
            "note": "sunt",
            "cheque_number": "occaecati"
        }
    ]
}
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://www.onoo.online/brand/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":1.37999999999999989341858963598497211933135986328125,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":1,"expense_for":15,"contact_id":12,"additional_notes":"est","is_recurring":0,"recur_interval":14,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"eligendi","recur_repetitions":3,"payment":[]}'
...
let body = {
    "final_total": 1.37999999999999989341858963598497211933135986328125,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 1,
    "expense_for": 15,
    "contact_id": 12,
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/expense-refund?location_id=esse&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=beatae&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/product?brand_id=accusantium&category_id=eligendi&sub_category_id=accusantium&location_id=reprehenderit&selling_price_group=omnis&name=animi&sku=et&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/product/1?selling_price_group=amet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/variation/?brand_id=commodi&category_id=dolorum&sub_category_id=modi&not_for_selling=qui&name=qui&sku=totam&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/sell?location_id=dolore&contact_id=hic&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=quibusdam&service_staff_id=optio&shipping_status=ordered&only_subscriptions=excepturi&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":19,"contact_id":12,"transaction_date":"2020-07-22 15:48:29","invoice_no":"facere","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":17,"discount_amount":10,"discount_type":"fixed","sale_note":"vel","staff_note":"dolores","commission_agent":16,"shipping_details":"Express Delivery","shipping_address":"voluptatem","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":9,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"consequatur","recur_repetitions":3,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":7,"service_custom_field_1":"ut","service_custom_field_2":"exercitationem","service_custom_field_3":"esse","service_custom_field_4":"ut","round_off_amount":256.4680172399999946719617582857608795166015625,"table_id":9,"service_staff_id":17,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":20,"note":"itaque"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":11,"card_number":"eos","card_holder_name":"vel","card_transaction_number":"nostrum","card_type":"rerum","card_month":"necessitatibus","card_year":"repellat","card_security":"eos","transaction_no_1":"quia","transaction_no_2":"hic","transaction_no_3":"aut","bank_account_number":"tempora","note":"pariatur","cheque_number":"nobis"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_3": "esse",
            "service_custom_field_4": "ut",
            "round_off_amount": 256.4680172399999946719617582857608795166015625,
            "table_id": 9,
            "service_staff_id": 17,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "account_id": 11,
                    "card_number": "eos",
                    "card_holder_name": "vel",
                    "card_transaction_number": "nostrum",
                    "card_type": "rerum",
                    "card_month": "necessitatibus",
                    "card_year": "repellat",
                    "card_security": "eos",
                    "transaction_no_1": "quia",
                    "transaction_no_2": "hic",
                    "transaction_no_3": "aut",
                    "bank_account_number": "tempora",
                    "note": "pariatur",
                    "cheque_number": "nobis"
                }
            ]
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://www.onoo.online/brand/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":16,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":8,"discount_amount":10,"discount_type":"fixed","sale_note":"rerum","staff_note":"blanditiis","sells":[{"is_suspend":false}],"commission_agent":13,"shipping_details":"Express Delivery","shipping_address":"et","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":9,"pay_term_number":5,"pay_term_type":"months","is_recurring":0,"recur_interval":20,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"et","recur_repetitions":15,"rp_redeemed":9,"rp_redeemed_amount":13.5,"types_of_service_id":19,"service_custom_field_1":"est","service_custom_field_2":"qui","service_custom_field_3":"harum","service_custom_field_4":"delectus","round_off_amount":61789.2479999999995925463736057281494140625,"table_id":14,"service_staff_id":14,"change_return":0,"change_return_id":11,"products":[{"sell_line_id":8,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":19,"discount_amount":0,"discount_type":"percentage","sub_unit_id":7,"note":"omnis"}],"payments":[{"payment_id":6,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":19,"card_number":"ullam","card_holder_name":"nulla","card_transaction_number":"temporibus","card_type":"ratione","card_month":"ex","card_year":"quaerat","card_security":"culpa","transaction_no_1":"praesentium","transaction_no_2":"molestiae","transaction_no_3":"similique","note":"aliquam","cheque_number":"ipsum","bank_account_number":"enim"}]}'
...
let body = {
    ...
    "service_custom_field_3": "harum",
    "service_custom_field_4": "delectus",
    "round_off_amount": 61789.2479999999995925463736057281494140625,
    "table_id": 14,
    "service_staff_id": 14,
    "change_return": 0,
    "change_return_id": 11,
    ...
    "payments": [
        {
            ...
            "card_transaction_number": "temporibus",
            "card_type": "ratione",
            "card_month": "ex",
            "card_year": "quaerat",
            "card_security": "culpa",
            "transaction_no_1": "praesentium",
            "transaction_no_2": "molestiae",
            "transaction_no_3": "similique",
            "note": "aliquam",
            "cheque_number": "ipsum",
            "bank_account_number": "enim"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://www.onoo.online/brand/public/connector/api/sell/autem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://www.onoo.online/brand/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":5,"transaction_date":"2020-5-7 15:20:22","invoice_no":"ut","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":19,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://www.onoo.online/brand/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":18,"shipping_status":"ordered","delivered_to":"id"}'
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/table?location_id=impedit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/taxonomy?type=qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/user?service_staff=quibusdam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/user"
);

let params = {
    "service_staff": "quibusdam",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://www.onoo.online/brand/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"vero","new_password":"et"}'
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/profit-loss-report?location_id=repellendus&start_date=2018-06-25&end_date=2018-06-25&user_id=sunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/profit-loss-report"
);

let params = {
    "location_id": "repellendus",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "user_id": "sunt",
};
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.online/brand/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.online/brand/public/connector/api/notifications"
);
